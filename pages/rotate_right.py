...
layout = [
    html.H1(children='rotate_right'),
    html.Div(children=dcc.Markdown('''
            Given a list argument `lst` of length 3, return an array with the elements "rotated right" so {'a', 'b', 'c'} 
            yields {'c', 'a', 'b'}. Ensure that all test cases have the argument be exactly length 3.
            '''),
             style={'textAlign': 'left',
                    }),
    dcc.Textarea(
        id='textarea-example',
        value='def rotate_right(lst):',
    ...
    if n_clicks:
        ...
        for row in rows:
            ...
            try:
                ...
                local_scope = {}
                exec("result10 = " + code, globals, locals)  # safer for simple expressions
                row['Output'] = locals.get('result10', '')
                locals2 = {"rotate_right":rotate_right}
                exec("result10 = " + code, globals, locals2)  # safer for simple expressions
                row['Expected'] = locals2.get('result10', '')
